...
import { useAddResume, useResumes } from '../hooks/useResumes'
import { downloadPDF, mergePDFWithText } from '../utils/pdfUtils'
...
const ResumeBuilder: React.FC = () => {
  ...
  const getActiveQuill = () => {
    ...
    switch (lastFocusedEditor) {
      case 'header':
        return headerQuill.current
      case 'sidebar':
        return sidebarQuill.current
      case 'mainContent':
        return mainContentQuill.current
      default:
        return headerQuill.current
    }
  }
  ...
  const saveDraft = async () => {
    ...
    try {
      ...
      const content = JSON.stringify(draftData)
      const fileName = selectedTemplate
        ? `resume-draft-${selectedTemplate}.json`
        : 'resume-draft-scratch.json'
  ...
  const loadDraft = async (templateId: 'modern' | 'classic' | 'scratch') => {
    try {
      const fileName = templateId === 'scratch'
        ? 'resume-draft-scratch.json'
        : `resume-draft-${templateId}.json`

      const resume = resumesData?.resumes.find((r) => r.file_name === fileName)

      if (resume) {
        const data = await queryClient.fetchQuery({
          queryKey: ['resume', resume.id],
          queryFn: async () => {
        ...
        if (data.success && data.resume.file_data) {
          const decoder = new TextDecoder()
          const text = decoder.decode(data.resume.file_data)
  ...
  const selectTemplate = async (id: 'modern' | 'classic') => {
    const fileName = `resume-draft-${id}.json`
    const resume = resumesData?.resumes.find((r) => r.file_name === fileName)
    ...
    <div className='bg-white dark:bg-gray-800 border-b border-gray-300 dark:border-gray-600 sticky top-0 z-50 shadow-sm'>
        ...
        <div className='flex items-center gap-1'>
          ...
          >
            <svg className='w-4 h-4' fill='currentColor' viewBox='0 0 20 20'>
              <path
                fillRule='evenodd'
                d='M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h4a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h4a1 1 0 110 2H4a1 1 0 01-1-1z'
                clipRule='evenodd'
              />
            </svg>
          </button>
        ...
        <div className='flex items-center gap-1'>
          ...
          >
            <svg className='w-4 h-4' fill='currentColor' viewBox='0 0 20 20'>
              <path
                fillRule='evenodd'
                d='M3 4a1 1 0 01.117-1.993L5 2.118V7H4a1 1 0 110-2h1V4.5a.5.5 0 01.5-.5h1a.5.5 0 010 1H6v1h.5a.5.5 0 010 1H6v1h1a1 1 0 110 2H4a1 1 0 01-1-1zm5-1a1 1 0 011-1h8a1 1 0 110 2H9a1 1 0 01-1-1zm0 6a1 1 0 011-1h8a1 1 0 110 2H9a1 1 0 01-1-1zm0 6a1 1 0 011-1h8a1 1 0 110 2H9a1 1 0 01-1-1z'
                clipRule='evenodd'
              />
            </svg>
          </button>
      ...
      <div className='px-4 py-1 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between text-xs text-gray-600 dark:text-gray-400'>
        <div className='flex items-center gap-4'>
          <span>
            Editing: <span className='font-medium capitalize'>{lastFocusedEditor}</span>
          </span>
          <span>•</span>
        ...
        <div className='px-4 sm:px-0'>
          ...
          <div className='bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden mb-8'>
            <div className='px-6 py-5 border-b border-gray-200 dark:border-gray-700'>
              ...
              <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
                Import existing resumes to optimize or use as reference
              </p>
            </div>
          ...
          {lastOptimizedFile && aiOptimizedResumes[lastOptimizedFile] && (
            <div className='bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden mb-8'>
              <div className='px-6 py-5 border-b border-gray-200 dark:border-gray-700'>
                ...
                <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
                  Review the AI-optimized resume below. You can apply it to the editor or dismiss.
                </p>
              </div>
              <div className='p-6'>
                <div className='max-w-7xl mx-auto'>
                  <div
                    className='bg-gray-50 dark:bg-gray-900 p-4 rounded-md border border-gray-200 dark:border-gray-700 text-sm text-gray-900 dark:text-gray-100 overflow-auto'
          ...
          <div className='bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden mb-8'>
            <div className='px-6 py-5 border-b border-gray-200 dark:border-gray-700'>
              ...
              <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
                Start from scratch or use a professional template
              </p>
            </div>
              ...
              <div className='flex flex-col sm:flex-row justify-center gap-6'>
                ...
                >
                  <div className='flex flex-col items-center gap-3'>
                    <svg
                      className={`w-12 h-12 ${resumeMode === 'scratch' ? 'text-white' : 'text-blue-600'}`}
                      fill='none'
                      stroke='currentColor'
                      viewBox='0 0 24 24'
                    >
                    ...
                    <div>
                      ...
                      <div
                        className={`text-sm mt-1 ${
                          resumeMode === 'scratch' ? 'text-blue-100' : 'text-gray-500 dark:text-gray-400'
                        }`}
                      >
                ...
                >
                  <div className='flex flex-col items-center gap-3'>
                    <svg
                      className={`w-12 h-12 ${resumeMode === 'template' ? 'text-white' : 'text-blue-600'}`}
                      fill='none'
                      stroke='currentColor'
                      viewBox='0 0 24 24'
                    >
                    ...
                    <div>
                      ...
                      <div
                        className={`text-sm mt-1 ${
                          resumeMode === 'template' ? 'text-blue-100' : 'text-gray-500 dark:text-gray-400'
                        }`}
                      >
          ...
          {hasSelectedMode && resumeMode === 'scratch' && (
            <div className='bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden'>
              <div className='px-6 py-5 border-b border-gray-200 dark:border-gray-700'>
                ...
                <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
                  Create your resume with full creative control
                </p>
              </div>
              ...
              <div className='p-6'>
                <div
                  className='bg-white dark:bg-gray-100 shadow-2xl border-2 border-gray-200 dark:border-gray-400 min-h-[1056px] max-w-[816px] mx-auto'
            ...
            <div className='bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden'>
              <div className='px-6 py-5 border-b border-gray-200 dark:border-gray-700'>
                <h2 className='text-xl font-semibold text-gray-900 dark:text-white capitalize'>
                  {selectedTemplate} Template Editor
                </h2>
                <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
                  Customize your professional resume template
                </p>
              </div>
                  ...
                  <div className='flex items-start gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-blue-800 dark:text-blue-200 mt-1'>
                        Use the toolbar above to format your text professionally. Your changes are auto-saved locally.
                        Click "Save Draft" to secure your progress, then "Download PDF" when you're ready to export your
                        polished resume.
                      </p>
                    </div>
                  </div>
